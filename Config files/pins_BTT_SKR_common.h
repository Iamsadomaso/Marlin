...
//
#ifndef TEMP_0_PIN
  #define TEMP_0_PIN                    P0_25_A2  // A1 (T1) - (68) - TEMP_0_PIN // rudy swapped temp 0 with temp1
#endif
#ifndef TEMP_1_PIN
  #define TEMP_1_PIN                    P0_24_A1  // A2 (T2) - (69) - TEMP_1_PIN // rudy as above
#endif
#ifndef TEMP_BED_PIN
  #define TEMP_BED_PIN                  P0_23_A0  // A0 (T0) - (67) - TEMP_BED_PIN
#endif

#if EXTRUDERS  == 1 && !REDUNDANT_TEMP_MATCH(SOURCE, E1) // Rudy Changed hotends to extruders as in config file
