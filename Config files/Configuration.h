 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 240 } //rudy: changed values, to verify and cal extruder
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 40, 45 } //rudy: changed
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 100, 5000 } //rudy:
...
#define CLASSIC_JERK //rudy: defined
  ...
  #define DEFAULT_XJERK 20.0 //rudy:changed from 10.0
  #define DEFAULT_YJERK 20.0 //rudy: changed from 10.0
  #define DEFAULT_ZJERK  0.4 //rudy: changed from 0.3
 ...
 */
#define AUTO_BED_LEVELING_3POINT //rudy:turned on form um as standard leveling
...
#define NOZZLE_CLEAN_FEATURE //rudy:
  ...
  #define NOZZLE_CLEAN_START_POINT { {  10, 10, (Z_MIN_POS + 20) } } //rudy:
  #define NOZZLE_CLEAN_END_POINT   { { 0, 0, (Z_MIN_POS + 28) } } //rudy:

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 2 //rudy:
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 //rudy:
#define LCD_FEEDBACK_FREQUENCY_HZ 5000 //rudy:
