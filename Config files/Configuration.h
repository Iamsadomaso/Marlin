...
#define STRING_CONFIG_H_AUTHOR "(Rudy, tst config)" // Who made the changes. rudy:
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_3 //rudy:changed to skr 1.3
#endif
 ...
 */
#define BAUDRATE 115200 //rudy:changed from 250000
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0 //rudy:changed from 0
...
#define CUSTOM_MACHINE_NAME "UM2 Go" //rudy: uncommented and named machine
 ...
 */
#define X_DRIVER_TYPE  TMC2130 //rudy:set tmc
#define Y_DRIVER_TYPE  TMC2130 //rudy:set tmc
#define Z_DRIVER_TYPE  TMC2130 //rudy:set tmc
...
#define E0_DRIVER_TYPE TMC2130 //rudy: set tmc
 ...
 */ 
#define TEMP_SENSOR_0 13  //rudy: changed to 13 HT NTC 100K not work shows 60C on cold
...
#define TEMP_SENSOR_BED 13 //rudy:changed to 13 HT NTC 100k
...
// @section pid temp
  ...
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash) //Rudy turned on
  #define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash) //Rudy turned on
#endif
...
#define EXTRUDE_MAXLENGTH 600 //rudy: set 600 for um2go
...
#define USE_YMAX_PLUG //rudy:set ymax
#define USE_ZMAX_PLUG //rudy: set zmax
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. Rudy: changed to true 
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. Rudy: changed to true 
...
#define DETECT_BROKEN_ENDSTOP // Rudy
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 240 } //rudy: changed values, to verify and calibrate extruder
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 10, 45 } //rudy: changed
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 50, 4000 } //rudy: lowered from 9000,9000,100,10000

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2 Rudy turned on
 ...
 */
#define CLASSIC_JERK //rudy: defined
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK 8.0 //rudy:changed from 20 to 10.0 and to 8
  #define DEFAULT_YJERK 8.0 //rudy:changed from 20 to 10.0 and to 8
  #define DEFAULT_ZJERK  0.3 //rudy: changed from 0.4
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2 Rudy turned on
 ...
 */
#define S_CURVE_ACCELERATION //rudy: enabled
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 } // Rudy: changed to 0
...
#define INVERT_Z_DIR true //Rudy: changed to invert axis
...
#define X_BED_SIZE 122 // Rudy 
#define Y_BED_SIZE 124 // Rudy 

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -14 // Rudy
#define Y_MIN_POS 0 
#define Z_MIN_POS 0
...
//#define AUTO_BED_LEVELING_LINEAR //rudy:turned on form um as standard leveling
 ...
 */
#define PREHEAT_BEFORE_LEVELING  // Rudy turned on
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 10          // Set Mesh bounds as an inset region of the bed Rudy changed from 10
 ...
 */
#define LCD_BED_LEVELING //rudy: turned on
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 20, 20, 20, 20 } // (mm) Left, Front, Right, Back insets Rudy
...
#define HOMING_FEEDRATE_MM_M { (30*60), (30*60), (4*60) } //Rudy: lowered to 30 from 50mm

// Validate that endstops are triggered on homing moves
#define VALIDATE_HOMING_ENDSTOPS //Rudy turned on
...
#define PREHEAT_6_LABEL       "GTP" // Extrudr GreenTEC Pro
 ...
 */
#define NOZZLE_PARK_FEATURE //rudy:

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), (Y_MAX_POS - 5), 20 } //Rudy
 ...
 */
#define NOZZLE_CLEAN_FEATURE //rudy:

#if ENABLED(NOZZLE_CLEAN_FEATURE)
  // Default number of pattern repetitions
  #define NOZZLE_CLEAN_STROKES  10 //rudy:
  ...
  #define NOZZLE_CLEAN_START_POINT { {  30, 30, (Z_MIN_POS + 1) } } //rudy:
  #define NOZZLE_CLEAN_END_POINT   { { 90, 60, (Z_MIN_POS + 1) } } //rudy:

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 6 //rudy:
 ...
 */
#define SD_CHECK_AND_RETRY //Rudy turned on
...
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 // Rudy 
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //rudy:
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2  // Rudy turned on
#define LCD_FEEDBACK_FREQUENCY_HZ 5000  // Rudy turned on
